...
export function CryptoScreener() {
  ...
  const fetchCryptoData = async () => {
    ...
    try {
      ...
      const watchlistedIds = mockAssets
        .filter((asset) => asset.isWatchlisted)
        .map((asset) => asset.id);
  ...
  useEffect(() => {
    const filtered = assets.filter((asset) => {
      ...
      const matchesFilters =
        (!filters.priceMin ||
          asset.price >= Number.parseFloat(filters.priceMin)) &&
        (!filters.priceMax ||
          asset.price <= Number.parseFloat(filters.priceMax)) &&
        (!filters.marketCapMin ||
          asset.marketCap >=
            Number.parseFloat(filters.marketCapMin) * 1000000) &&
        (!filters.marketCapMax ||
          asset.marketCap <=
            Number.parseFloat(filters.marketCapMax) * 1000000) &&
        (!filters.volumeMin ||
          asset.volume24h >= Number.parseFloat(filters.volumeMin) * 1000000) &&
        (!filters.change24hMin ||
          asset.change24h >= Number.parseFloat(filters.change24hMin)) &&
        (!filters.change24hMax ||
          asset.change24h <= Number.parseFloat(filters.change24hMax)) &&
        (!filters.sector ||
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Advanced cryptocurrency screening and filtering
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-4">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, marketCapMin: e.target.value })
                    }
                    type="number"
                  />
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, marketCapMax: e.target.value })
                    }
                    type="number"
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, change24hMin: e.target.value })
                    }
                    type="number"
                  />
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, change24hMax: e.target.value })
                    }
                    type="number"
                  />
                </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, rsiMin: e.target.value })
                    }
                    type="number"
                    min="0"
                    max="100"
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFilters({ ...filters, rsiMax: e.target.value })
                    }
                    type="number"
                    min="0"
                    max="100"
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFilters({ ...filters, volumeMin: e.target.value })
                  }
                  type="number"
                />
              </div>
              ...
              <TableBody>
                {filteredAssets.map((asset) => (
                  <TableRow key={asset.id}>
                    ...
                    <TableCell className={getRSIColor(asset.rsi)}>
                      {asset.rsi.toFixed(1)}
                    </TableCell>
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={getMACDColor(asset.macd)}
                      >
                        {asset.macd}
                      </Badge>
                    </TableCell>
