      ...
      const mockSignals: TradingSignal[] = [
        {
          ...
          currentPrice: 43200,
          reasoning:
            "Breakout above key resistance with high volume confirmation",
          timeframe: "4h",
        },
        {
          symbol: "ETH",
                  ...
                  {Object.entries(prediction.predictions).map(
                    ([timeframe, pred]) => (
                      ...
                      >
                        ...
                        <div
                          className={`text-xs ${pred.change >= 0 ? "text-green-600" : "text-red-600"}`}
                        >
                          {pred.change >= 0 ? "+" : ""}
        ...
        {marketStructure && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Deep analysis of market structure and key levels
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-3 border rounded-lg text-center">
                  ...
                  <div className="font-medium text-green-600">
                    ${marketStructure.support.toLocaleString()}
                  </div>
                </div>
                <div className="p-3 border rounded-lg text-center">
                  <div className="text-xs text-muted-foreground mb-1">
                  ...
                  <div className="font-medium text-red-600">
                    ${marketStructure.resistance.toLocaleString()}
                  </div>
                </div>
              </div>
