...
import { Menu, Home, TrendingUp, Bot, Settings, Bell, User, LogOut, Shield, BarChart3 } from "lucide-react"
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="text-xl font-bold text-[#30D5C8]">CoinWayFinder</span>
          </Link>
        </div>
                    ...
                    {user?.role === "admin" && (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          Admin
                          <Badge className="ml-2 bg-red-500/10 text-red-400 border-red-500/20">Admin</Badge>
                        </div>
                      </Link>
                    )}
                  </div>
          ...
          {user?.role === "admin" && (
            ...
            >
              <div className="flex items-center">
                ...
                Admin
                <Badge className="ml-2 bg-red-500/10 text-red-400 border-red-500/20 text-xs">Admin</Badge>
              </div>
            </Link>
          )}
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-gray-900 border-gray-800" align="end" forceMount>
              ...
              <DropdownMenuSeparator className="bg-gray-800" />
              <DropdownMenuItem className="text-gray-300 hover:bg-gray-800 hover:text-white" onClick={handleLogout}>
