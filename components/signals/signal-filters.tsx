  ...
  return (
    <Card className="bg-[#1A1B23] border-gray-800">
        ...
        <div className="flex items-center justify-between">
          <CardTitle className="text-white flex items-center gap-2">
            ...
            {getActiveFilterCount() > 0 && (
              <Badge
                variant="secondary"
                className="bg-[#30D5C8] text-[#191A1E]"
              >
      ...
      <CardContent className="space-y-6">
            ...
            <div className="flex flex-wrap gap-2">
              {filters.symbols.map((symbol) => (
                <Badge
                  key={symbol}
                  variant="secondary"
                  className="bg-[#30D5C8]/20 text-[#30D5C8]"
                >
                  {symbol}
                  <X
        ...
        {/* Strategies */}
        <Collapsible
          open={expandedSections.strategies}
          onOpenChange={() => toggleSection("strategies")}
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
            ...
            {strategies.map((strategy) => (
              <div key={strategy} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={() =>
                    toggleArrayFilter("strategies", strategy)
                  }
                />
                <Label
                  htmlFor={strategy}
        ...
        {/* Exchanges */}
        <Collapsible
          open={expandedSections.exchanges}
          onOpenChange={() => toggleSection("exchanges")}
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
            ...
            {exchanges.map((exchange) => (
              <div key={exchange} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={() =>
                    toggleArrayFilter("exchanges", exchange)
                  }
                />
                <Label
                  htmlFor={exchange}
        ...
        {/* Timeframes */}
        <Collapsible
          open={expandedSections.timeframes}
          onOpenChange={() => toggleSection("timeframes")}
        >
          <CollapsibleTrigger asChild>
            <Button
              variant="ghost"
            ...
            {timeframes.map((timeframe) => (
              <div key={timeframe} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={() =>
                    toggleArrayFilter("timeframes", timeframe)
                  }
                />
                <Label
                  htmlFor={timeframe}
