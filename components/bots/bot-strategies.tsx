...
import { TrendingUp, BarChart3, Zap, Target, Repeat, Brain, ArrowUpDown, Layers } from "lucide-react"
...
export function BotStrategies() {
  const strategies = [
    {
      ...
      pros: ["Reduces volatility impact", "Simple to understand", "Great for beginners"],
    ...
    },
    {
      ...
      pros: ["Profits from sideways markets", "Consistent small gains", "Works in volatility"],
    ...
    },
    {
      ...
      description: "Follow strong price trends and ride the momentum for maximum gains",
      icon: TrendingUp,
      difficulty: "Intermediate",
      riskLevel: "Medium-High",
      timeframe: "Short-Medium",
      features: ["Trend following", "Momentum indicators", "Breakout detection", "Stop-loss protection"],
      pros: ["Catches big moves", "Clear entry/exit signals", "Good risk/reward"],
    ...
    },
    {
      id: "arbitrage",
      name: "Arbitrage Bot",
      description: "Exploit price differences between exchanges for risk-free profits",
      icon: ArrowUpDown,
      difficulty: "Advanced",
      riskLevel: "Low",
      timeframe: "Instant",
      features: ["Multi-exchange monitoring", "Price difference detection", "Instant execution", "Risk-free profits"],
      pros: ["Low risk", "Consistent profits", "Market neutral"],
      cons: ["Requires multiple exchanges", "Small margins", "High competition"],
    ...
    },
    {
      id: "mean-reversion",
      name: "Mean Reversion",
      description: "Buy when price is below average, sell when above - profit from price corrections",
      icon: Target,
      difficulty: "Intermediate",
      riskLevel: "Medium",
      timeframe: "Medium",
      features: ["Statistical analysis", "Overbought/oversold detection", "Price normalization", "Risk management"],
      pros: ["Works in ranging markets", "Statistical edge", "Good risk control"],
    ...
    },
    {
      ...
      description: "Machine learning algorithm that adapts to market conditions automatically",
      icon: Brain,
      difficulty: "Advanced",
      riskLevel: "Medium",
      timeframe: "Adaptive",
      features: ["Machine learning", "Market adaptation", "Pattern recognition", "Self-optimization"],
    ...
    },
    {
      ...
      description: "Automatically maintain target allocation across multiple cryptocurrencies",
      icon: Layers,
      difficulty: "Beginner",
      riskLevel: "Low-Medium",
      timeframe: "Long-term",
      features: ["Multi-asset management", "Automatic rebalancing", "Target allocation", "Diversification"],
  ...
  return (
    <section className="mb-12">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-2">🎯 Trading Strategies</h2>
        <p className="text-gray-300">Choose from our proven algorithmic trading strategies</p>
      </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-[#30D5C8]">{strategy.avgReturn}</p>
                </div>
              </div>
              ...
              {/* Best For */}
              <div>
                <p className="text-xs font-medium text-[#30D5C8] mb-1">Best For</p>
