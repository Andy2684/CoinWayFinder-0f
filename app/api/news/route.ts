...
const MOCK_NEWS = [
  ...
  },
  {
    ...
    content:
      "Ethereum 2.0 validators are experiencing record-high staking rewards as network activity reaches new peaks. The combination of increased transaction fees and MEV rewards has made staking more attractive than ever. With over 32 million ETH now staked, the network's security continues to strengthen. The high rewards are attributed to increased DeFi activity and the growing popularity of Layer 2 solutions that still settle on the Ethereum mainnet. Validators are reporting annual yields exceeding 8%, significantly higher than traditional financial instruments.",
  ...
  },
  {
    ...
    content:
      "A major DeFi lending protocol has suffered a $50 million exploit due to a smart contract vulnerability. The attack involved a complex flash loan manipulation that drained funds from the protocol's liquidity pools. The team has paused the protocol and is working with security firms to investigate the incident. This exploit highlights the ongoing risks in DeFi protocols and the importance of thorough security audits. The protocol's native token has dropped 60% following the news, and several other DeFi tokens have also declined on contagion fears.",
    source: "DeFiWatch",
  ...
  },
  {
    ...
    content:
      "The Federal Reserve has announced the launch of a pilot program for a Central Bank Digital Currency (CBDC). The program will test the feasibility and implications of a digital dollar in controlled environments. This development could significantly impact the cryptocurrency landscape and traditional banking systems. The pilot will involve select financial institutions and will focus on wholesale transactions initially. Privacy and security features are being carefully evaluated as part of the testing process.",
    source: "FinanceToday",
  ...
  },
  {
    ...
    content:
      "The NFT market is showing signs of recovery with trading volumes increasing by 150% over the past week. Blue-chip collections are leading the recovery, with floor prices rising across major marketplaces. New utility-focused projects are gaining traction as the market matures beyond speculative trading. Gaming NFTs and metaverse assets are particularly strong, with several major gaming companies announcing NFT integration plans. The recovery suggests a shift toward more sustainable NFT ecosystems focused on real-world utility.",
    source: "NFTInsider",
  ...
  },
  {
    ...
    content:
      "Ethereum Layer 2 solutions are experiencing massive adoption growth, with total value locked (TVL) reaching new highs. Arbitrum and Optimism lead the charge with improved user experience and lower transaction costs. The growth signals a maturing ecosystem that's addressing Ethereum's scalability challenges. Daily active users on Layer 2 networks have increased by 300% over the past quarter. Major DeFi protocols are expanding to Layer 2 networks, offering users significant cost savings on transactions.",
    source: "Layer2News",
  ...
  },
  {
    ...
    content:
      "Several major financial institutions have announced expansions to their cryptocurrency custody solutions, signaling growing institutional demand. The services now support a wider range of digital assets and offer enhanced security features. This development is expected to accelerate institutional adoption of cryptocurrencies. Major banks are partnering with specialized crypto custody providers to offer comprehensive services. The expansion includes support for DeFi protocols and staking services, indicating institutional interest in yield-generating crypto strategies.",
